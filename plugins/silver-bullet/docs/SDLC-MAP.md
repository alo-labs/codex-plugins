...
| **Testing** | `silver:test`, `silver:verify`, `verify-tests`, `silver:completion-audit`, `silver:domain-audit` | TEST-ENGINEERING.md, VERIFICATION.md, UAT.md, test freshness marker, DOMAIN-AUDIT.md | Completion audit, stop gate, test freshness gate, test-health pack | Full |
...
- **Full coverage (14/14):** Ideation through Maintenance, including specialized domain packs, deployment evidence, canary watch, incident/retro loops, and content/search workflows.
