...
| # | Path | Trigger | Status |
|---|---|---|---|
| 1 | Pre-v0.30.0: every `compact` event stripped `gsd-*` markers | `context compaction` mid-feature wiped GSD progress | ✅ **Fixed in v0.30.0 #87 Bug 1** — only `startup` and `clear` mutate state |
