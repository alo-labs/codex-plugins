...
| `AF-DECIDE` | decision_research | `templates/orchestrator-workers/DECIDE.md` | `silver-multi-ai-task`, `review-research`, `silver-research` |
...
| `FS-MULTI_AI_TASK` | `silver-multi-ai-task` | `AF-DECIDE` | `EV-FS-MULTI_AI_TASK` |
