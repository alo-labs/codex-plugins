...
| Silver Bullet Commands | Slash-command surface for Silver Bullet workflows. | Thin command wrapper that routes `/silver:*` entry points into the Silver Bullet workflow package. |
