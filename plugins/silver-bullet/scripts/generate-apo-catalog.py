...
def build_catalog() -> dict:
    ...
    return {
        ...
        "tool_policies": [
            ...
            {"id": "TP-SEARCH-CLI", "tool_id": "search_cli", "policy_name": "once-opted-in-then-mandatory-when-relevant", "opt_in_state_source": ".silver-bullet.json recommended_tools.search_cli", "relevance_rules": ["deep research retrieval", "ultradeep state-of-the-art review", "external source triangulation"], "required_evidence": "run_manifest.json provider status or fallback rationale", "failure_policy": "degrade"},
        ],
        "dynamic_rules": [
