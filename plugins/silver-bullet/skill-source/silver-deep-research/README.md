# Silver Deep Research Skill

Enterprise-grade research engine for Silver Bullet. Produces citation-backed reports with source credibility scoring, multi-provider search, phase-level V-loops, and automated validation.

## Installation

```bash
# Source lives in the Silver Bullet repo
skills/silver-deep-research/
```
...
Reports are saved to `.planning/research/<date>-<slug>/`:
